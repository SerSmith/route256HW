...
// Validate checks the field values on ItemOrder with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ItemOrder) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ItemOrder with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ItemOrderMultiError, or nil
// if none found.
func (m *ItemOrder) ValidateAll() error {
	return m.validate(true)
}

func (m *ItemOrder) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ItemOrderMultiError(errors)
	}

	return nil
}

// ItemOrderMultiError is an error wrapping multiple validation errors returned
// by ItemOrder.ValidateAll() if the designated constraints aren't met.
type ItemOrderMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ItemOrderMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m ItemOrderMultiError) AllErrors() []error { return m }

// ItemOrderValidationError is the validation error returned by
// ItemOrder.Validate if the designated constraints aren't met.
type ItemOrderValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e ItemOrderValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ItemOrderValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ItemOrderValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ItemOrderValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ItemOrderValidationError) ErrorName() string { return "ItemOrderValidationError" }

// Error satisfies the builtin error interface
func (e ItemOrderValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = ItemOrderValidationError{}
...
// Validate checks the field values on ItemStock with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ItemStock) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ItemStock with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ItemStockMultiError, or nil
// if none found.
func (m *ItemStock) ValidateAll() error {
	return m.validate(true)
}

func (m *ItemStock) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ItemStockMultiError(errors)
	}

	return nil
}

// ItemStockMultiError is an error wrapping multiple validation errors returned
// by ItemStock.ValidateAll() if the designated constraints aren't met.
type ItemStockMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ItemStockMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ItemStockMultiError) AllErrors() []error { return m }

// ItemStockValidationError is the validation error returned by
// ItemStock.Validate if the designated constraints aren't met.
type ItemStockValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ItemStockValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ItemStockValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ItemStockValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ItemStockValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ItemStockValidationError) ErrorName() string { return "ItemStockValidationError" }

// Error satisfies the builtin error interface
func (e ItemStockValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = ItemStockValidationError{}
